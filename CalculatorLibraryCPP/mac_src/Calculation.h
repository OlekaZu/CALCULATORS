...
#ifndef MODEL_CALCULATION_H_
#define MODEL_CALCULATION_H_
...
extern "C" s21::Calculation* CreateCalculationClass();

extern "C" void DisposeCalculationClass(s21::Calculation* ptr_object);

extern "C" void CallCalculate(s21::Calculation* ptr_object, const char* input,
                              double x_argument);

extern "C" double CallGetData(s21::Calculation* ptr_object);

extern "C" const char* CallGetError(s21::Calculation* ptr_object);

extern "C" const char* CallGetInput(s21::Calculation* ptr_object);

#endif  // MODEL_CALCULATION_H_