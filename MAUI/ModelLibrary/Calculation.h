...
extern "C" MODELLIBRARY_API void DisposeCalculationClass(s21::Calculation * ptr_object);

extern "C" MODELLIBRARY_API void CallCalculate(s21::Calculation * ptr_object, const char* input, double x_argument);

extern "C" MODELLIBRARY_API double CallGetData(s21::Calculation * ptr_object);

extern "C" MODELLIBRARY_API const char* CallGetError(s21::Calculation * ptr_object);

extern "C" MODELLIBRARY_API const char* CallGetInput(s21::Calculation * ptr_object);